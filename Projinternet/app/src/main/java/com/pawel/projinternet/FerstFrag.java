...
public class FerstFrag extends Fragment  implements LoaderManager.LoaderCallbacks<String> {
  ...
  //  private Button ustaw;
    ...
    private final int LOADER_id = 23;

    private String jedn = "&units=metric";

    public static FerstFrag newIstance(){
        FerstFrag fragm = new FerstFrag();
        return fragm;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View viev = inflater.inflate(R.layout.pusty, container, false);
       ...
       // SerchBt = (Button) viev.findViewById(R.id.But);
        ...
        //ustaw = (Button) viev.findViewById(R.id.But2);
        ...
        /*ustaw.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity().getApplicationContext(), PAktivity.class);
    ...
    public void onResume() {
        ...
        if (czyInternet()) {
            String query = BASE_URL + citys + APT_KEY + jedn;
            Uri uri = Uri.parse(query);
            URL url = null;
            ...
            if (url != null) {
                ...
                if (stringLoader == null) {
                    getActivity().getSupportLoaderManager().initLoader(LOADER_id, queryBundle, this);
                } else {
                    getActivity().getSupportLoaderManager().restartLoader(LOADER_id, queryBundle, this);
                }
            }
        } else {
            Toast.makeText(getActivity().getApplicationContext(), "Nie masz Internetu", Toast.LENGTH_SHORT).show();
